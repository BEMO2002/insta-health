  ...
  const carouselItems = [
    {
      ...
      descriptionTwo:
        "هي منصة لحجز خدمات الرعاية الصحية في منزلك بحيث تربطالمرضى بالعديد من الخدمات الطبية  من خلالنخبة من  أفضل مقدمي الرعاية الصحية من المستشفيات و المراكز الطبية إما من خلال الزيارات المنزلية أو الاستشارات الطبية",
    },
    {
      id: 2,
      image: image2,
